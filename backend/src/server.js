...
// DEBUG: Test route to verify public access (using /test path, NOT /api)
...
// OTP Authentication Routes - Using /auth path (NOT protected by /api middleware)
app.post('/auth/send-login-otp', otpController.sendLoginOTP);
app.post('/auth/verify-login-otp', otpController.verifyLoginOTP);
app.post('/auth/send-registration-otp', otpController.sendRegistrationOTP);
app.post('/auth/verify-registration-otp', otpController.verifyRegistrationOTP);
app.post('/auth/resend-otp', otpController.resendOTP);
