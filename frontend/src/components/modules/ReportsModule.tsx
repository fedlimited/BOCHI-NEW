  ...
  useEffect(() => {
    async function loadProjects() {
      try {
        ...
        const projectsRes = await fetch('https://bochaberi-suite.onrender.com/api/projects', {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        let income = await fetch('https://bochaberi-suite.onrender.com/api/income', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
        
        let expenses = await fetch('https://bochaberi-suite.onrender.com/api/expenses', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        let projectsData = await fetch('https://bochaberi-suite.onrender.com/api/projects', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
...
function OrdersReport() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        const token = localStorage.getItem('token');
        let orders = await fetch('https://bochaberi-suite.onrender.com/api/purchase-orders', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
...
function StoresSummaryReport() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        const token = localStorage.getItem('token');
        let transactions = await fetch('https://bochaberi-suite.onrender.com/api/store-transactions', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
...
function SiteDiaryReport() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        const token = localStorage.getItem('token');
        let entries = await fetch('https://bochaberi-suite.onrender.com/api/site-diary-entries', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
    ...
    async function loadProjectsAndSubcontractors() {
      try {
        ...
        const [projectsRes, subsRes] = await Promise.all([
          fetch('https://bochaberi-suite.onrender.com/api/projects', {
            headers: { 'Authorization': `Bearer ${token}` }
          }),
          fetch('https://bochaberi-suite.onrender.com/api/subcontractors', {
            headers: { 'Authorization': `Bearer ${token}` }
          })
        ]);
        const projectsData = await projectsRes.json();
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        let quotations = await fetch('https://bochaberi-suite.onrender.com/api/quotations', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
        ...
        let allSubcontractors = await fetch('https://bochaberi-suite.onrender.com/api/subcontractors', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        let allProjects = await fetch('https://bochaberi-suite.onrender.com/api/projects', {
          headers: { 'Authorization': `Bearer ${token}` }
        }).then(res => res.json());
