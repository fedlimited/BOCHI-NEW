    ...
    async function loadData() {
      ...
      try {
        ...
        const [quotationsRes, expensesRes, subsRes] = await Promise.all([
          fetch('https://bochaberi-suite.onrender.com/api/quotations', { headers: { 'Authorization': `Bearer ${token}` } }),
          fetch('https://bochaberi-suite.onrender.com/api/expenses', { headers: { 'Authorization': `Bearer ${token}` } }),
          fetch('https://bochaberi-suite.onrender.com/api/subcontractors', { headers: { 'Authorization': `Bearer ${token}` } })
        ]);
