...
export function TestLogin() {
  ...
  const sendOTP = async () => {
    setMessage('Sending...');
    try {
      const res = await fetch('https://bochaberi-suite.onrender.com/api/auth/send-login-otp', {
        method: 'POST',
  ...
  const verifyOTP = async () => {
    ...
    try {
      const res = await fetch('https://bochaberi-suite.onrender.com/api/auth/verify-login-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
